...
class BlogCategoryController extends ApiBaseController
{
    ...
    {
        $blogCategories = $this->_blogService->getAllBlogCategories($request);
    ...
    {
        $blogCategories = $this->_blogService->getAllSearchBlogCategories($request);
    ...
    {
        $blogCategories = $this->_blogService->getAllSearchPageBlogCategories($request);
    ...
    {
        $blogCategory = $this->_blogService->getBlogCategory($id);
    ...
    {
        $storeBlogCategoryResponse = $this->_blogService->storeBlogCategory($request);
    ...
    {
        $updateBlogCategoryResponse = $this->_blogService->updateBlogCategory($id, $request);
    ...
    {
        $deleteBlogCategoryResponse = $this->_blogService->destroyBlogCategory($id);
